...
| 파일 | 역할 |
|------|------|
| `tokens/design-tokens.css` | CSS 변수 토큰 (색상, 폰트, 간격, 다크모드) |
| `tokens/tailwind.preset.js` | Tailwind CSS 프리셋 |
| `docs/STYLE_GUIDE.md` | 스타일 규칙 (Do / Don't) |
| `docs/DATA_DISPLAY.md` | 데이터 표현 원칙 (레이아웃 순서, KPI, 밀도) |
| `docs/COMPONENTS.md` | 13개 컴포넌트 패턴 (CSS + Tailwind 병기) |
...
- `design-tokens.css`의 토큰 값을 인라인 스타일로 적용
...
- [ ] **접근성**: 색상만으로 정보를 전달하지 않고, 텍스트/아이콘을 병기하는가?
